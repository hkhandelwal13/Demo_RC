  ...
  return (
    ...
    <div className="Btn-div">
          ...
          <p className="mb-0">{loggedIn && localStorage.getItem("contractAccept") ?  < CountdownRedirect /> :" "} </p>
            ...
            <ul>  <Link to="/register"  className='nav-link' >Register</Link> </ul>
            <ul>  <Link to="/instruction"  className='nav-link' >Instruction</Link> </ul>
            <ul>  <Link to="/question"  className='nav-link' >QuestionHub</Link>  </ul>
            ...
            <ul>  <Link to="/result"  className='nav-link' >Result</Link>  </ul>
